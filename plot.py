...
def plot_noise(dataset_name):
    ...
    y7 = [1.187148, 1.381492, 1.499855, 2.084450, 1.653089, 2.005807, 3.901273, ]
    ...
    plt.plot(range(len(x)), y3, color='#8dabb6', marker='s', linestyle='--', label='Random anomaly')
    plt.plot(range(len(x)), y4, color='#8dabb6', marker='s', linestyle='--', label='Structural anomaly')
    plt.plot(range(len(x)), y5, color='#ddccc5', marker='D', linestyle='-.', label='Gaussian noise and Random anomaly')
    plt.plot(range(len(x)), y6, color='#ffa289', marker='h', linestyle=':', label='Gaussian noise and Exponential anomaly')
    plt.plot(range(len(x)), y7, color='#ffa289', marker='h', linestyle=':', label='Gaussian noise and Structural anomaly')
    plt.xticks(range(len(x)), x)
    plt.legend()
    plt.xlabel('Missing ratio', fontsize=12)
    plt.ylabel('ER', fontsize=12)
