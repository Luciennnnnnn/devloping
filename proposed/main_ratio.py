...
if __name__ == '__main__':
    ...
    logging.info('VITDA ratio ----- dataset: %s, ed: %d, R: %d, mu: %d, sigma: %f, noise_scheme: %s, outliers_scheme: %s'%(args.dataset, ed, R, mu, sigma, args.noise_scheme, args.outliers_scheme))     
    start = time.time()
